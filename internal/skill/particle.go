...
// generateID returns a small random id for skill entities (mirrors entity's
// helper without importing the entity package).
func generateID() string {
	return "s" + string(rune('a'+rl.GetRandomValue(0, 25))) +
		string(rune('0'+rl.GetRandomValue(0, 9)))
}
